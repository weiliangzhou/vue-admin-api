...
public class SysAdminExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value, "com.yd.lottery.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addRoleIdsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            roleIdsCriteria.add(new Criterion(condition, value1, value2, "com.yd.lottery.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        public Criteria andKidEqualToColumn(SysAdmin.Column column) {
        ...
        public Criteria andKidNotEqualToColumn(SysAdmin.Column column) {
            addCriterion(new StringBuilder("kid <> ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andKidGreaterThanColumn(SysAdmin.Column column) {
            addCriterion(new StringBuilder("kid > ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andKidGreaterThanOrEqualToColumn(SysAdmin.Column column) {
            addCriterion(new StringBuilder("kid >= ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andKidLessThanColumn(SysAdmin.Column column) {
            addCriterion(new StringBuilder("kid < ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andKidLessThanOrEqualToColumn(SysAdmin.Column column) {
            addCriterion(new StringBuilder("kid <= ").append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
    ...
    public interface IExampleWhen {
        void example(com.yd.lottery.db.domain.SysAdminExample example);
    }
}